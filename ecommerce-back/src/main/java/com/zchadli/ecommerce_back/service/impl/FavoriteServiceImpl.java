...
public class FavoriteServiceImpl implements FavoriteService {
    ...
    @Override
    public FavoriteResponse toggleFavorite(User user, Long idProduct) {
        ...
        if(favoriteOptional.isPresent()) {
            ...
            return new FavoriteResponse(false, "Product "+product.getName()+" just been removed from favorites.");
        }
        Favorite favorite = new Favorite();
        favorite.setUser(user);
        favorite.setProduct(product);
        favoriteDao.save(favorite);
        return new FavoriteResponse(true, "Product "+product.getName()+" just been added to favorites.");
    }
}
